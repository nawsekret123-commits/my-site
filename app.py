...
WHATSAPP_NUMBER = os.getenv("WHATSAPP_NUMBER", "87078340913")
...
<html lang="ru">
<head>
<script async src="https://www.googletagmanager.com/gtag/js?id=G-H0SPKMCK1L"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-H0SPKMCK1L');
</script>
    <meta charset="UTF-8">
...
<link rel="shortcut icon" href="https://cdn-icons-png.flaticon.com/512/4712/4712109.png">
...
<section class="hero">
    ...
    <a href="https://t.me/{{ telegram_username }}" class="telegram-btn" target="_blank" aria-label="Telegram">
        <svg viewBox="0 0 24 24" aria-hidden="true">
            <path d="M21.5 4.5L18.4 19c-.2 1-.8 1.2-1.6.8l-4.5-3.3-2.2 2.1c-.2.2-.4.4-.8.4l.3-4.6 8.4-7.6c.4-.3-.1-.5-.5-.2L7 13.1l-4.4-1.4c-.9-.3-.9-.9.2-1.3L20 3.7c.8-.3 1.7.2 1.5.8z"></path>
        </svg>
    </a>
    {% endif %}

    <a href="https://wa.me/{{ whatsapp_number }}" class="whatsapp-btn" target="_blank" aria-label="WhatsApp">
...
def home():
    ...
    return render_template_string(HTML, message=message, whatsapp_number=WHATSAPP_NUMBER, telegram_username=TELEGRAM_USERNAME)
